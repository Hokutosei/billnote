...
class MonthsControllerTest < ActionController::TestCase
  ...
  test "should create month" do
    assert_difference('Month.count') do
      post :create, month: { mybill_id: @month.mybill_id, mydebt_id: @month.mydebt_id, user_id: @month.user_id, year: @month.year, year_id: @month.year_id }
    end
  ...
  test "should update month" do
    put :update, id: @month, month: { mybill_id: @month.mybill_id, mydebt_id: @month.mydebt_id, user_id: @month.user_id, year: @month.year, year_id: @month.year_id }
    assert_redirected_to month_path(assigns(:month))
  end
