...
class YearsControllerTest < ActionController::TestCase
  ...
  test "should create year" do
    assert_difference('Year.count') do
      post :create, year: { mybill_id: @year.mybill_id, mydebt_id: @year.mydebt_id, user_id: @year.user_id, year: @year.year }
    end
  ...
  test "should update year" do
    put :update, id: @year, year: { mybill_id: @year.mybill_id, mydebt_id: @year.mydebt_id, user_id: @year.user_id, year: @year.year }
    assert_redirected_to year_path(assigns(:year))
  end
